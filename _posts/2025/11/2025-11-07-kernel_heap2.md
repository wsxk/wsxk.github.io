...
- [1. kernel heap使用范式](#1-kernel-heap使用范式)
  ...
  - [1.2 内核接口](#12-内核接口)
- [2. 内核保护机制查询](#2-内核保护机制查询)
- [3. 内核堆漏洞](#3-内核堆漏洞)
  - [3.1 oob(out of boundry)：堆溢出](#31-oobout-of-boundry堆溢出)
  - [3.2 UAF](#32-uaf)
  - [3.3 overlapping allocation](#33-overlapping-allocation)
- [4.  泄露内核地址](#4--泄露内核地址)
  - [4.1 Oops泄露kernel地址绕过kaslr](#41-oops泄露kernel地址绕过kaslr)
- [5. 内核堆利用技巧](#5-内核堆利用技巧)
  - [5.1 Heap Spraying —— anit-freelist\_randomization](#51-heap-spraying--anit-freelist_randomization)
    - [5.1.1 OOB+Heap Spraying破解freelist\_randomization](#511-oobheap-spraying破解freelist_randomization)
  - [5.2 modprobe\_path —— 以内核权限执行任意文件](#52-modprobe_path--以内核权限执行任意文件)
    - [5.2.1 Oops泄露内核地址+UAF修改next\_ptr实现任意地址分配修改modprobe\_path](#521-oops泄露内核地址uaf修改next_ptr实现任意地址分配修改modprobe_path)
  - [5.x 堆布局构造](#5x-堆布局构造)
...
## 5.1 Heap Spraying —— anit-freelist_randomization<br>
...
```
### 5.1.1 OOB+Heap Spraying破解freelist_randomization<br>
...
## 5.2 modprobe_path —— 以内核权限执行任意文件<br>
