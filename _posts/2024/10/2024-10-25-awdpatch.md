...
- [2. 格式化字符串](#2-格式化字符串)
  - [2.1 改eframe段+text段](#21-改eframe段text段)
  - [2.2 只改text段](#22-只改text段)
- [3. 堆](#3-堆)
  - [3.1 uaf](#31-uaf)
...
### 2.2 只改text段<br>
有的时候check比较严格，只允许你修改代码周边的位置。<br>
![](https://raw.githubusercontent.com/wsxk/wsxk_pictures/main/2024-9-25/20251123230443.png)
...
在checker校验比较严格时：需要关注汇编上下文的管理，做出合理的改动<br>
...
### 3.3 OOM<br>
修改堆溢出，需要把标识size的值，替换为原先记录heap大小。
